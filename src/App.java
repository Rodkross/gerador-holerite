...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        OperadoraCaixa operadorCaixa1 = new OperadoraCaixa("Elizandra Muniz",
                "Drogaria Nossa Farma ltda", 30, 0, 1, 0, 0, 0, true, true, 125.00);

        Entregador entregador1 = new Entregador("Caio Martins Alves", "Drogaria Nossa Farma ltda", 30, 0, 3, 45, 125,1, true, false);   
